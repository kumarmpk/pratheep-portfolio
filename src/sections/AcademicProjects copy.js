    ...
    return (
      <div>
        <Row xs="1" sm="1" md="2" className="topRow">
          <Col>
            <div className="flip-card pushUp">
                  ...
                  <Card className="mainCard">
                    <Card.Body>
                      ...
                      <Row>
                        <Col>
                          <p>
                            <b>Goal:</b> To create a simple data base management
                            system (DBMS).
                          </p>
                          ...
                          <Row>
                            ...
                            <Col sm={10} style={{ paddingTop: "0.5rem" }}>
                              Technologies: Java, Spring boot, JSON, HTML,
                              Thymeleaf
                            </Col>
                          </Row>
                        </Col>
            ...
            <Card className="mainCard">
              <Card.Body>
                ...
                <Row>
                  <Col>
                    <p>
                      <b>Goal: </b>To write clean code in test driven
                      development as per industrial standards using Agile
                      methodology.
                    </p>
                    ...
                    <p>
                      ...
                      personality, player age, player relative strength, and
                      draft picks.
                    </p>
                    <Row>
                      <Col sm={1}>
              ...
              <Card.Body>
                ...
                <Row>
                  <Col>
                    ...
                    <p>
                      <Asterisk />
                      The application allows users to create a sporting event,
                      and update a sporting event.
                    </p>
                    <p>
                      <Asterisk />
              ...
              <Card.Body>
                ...
                <Row>
                  <Col>
                    ...
                    <p>
                      <Asterisk />A web application was created using services
                      of three different cloud providers.
                    </p>
                    <p>
                      <Asterisk />
                      The application is divided into three major modules and
                      each module is deployed in a cloud provider.
                    </p>
                    <p>
                      <Asterisk />
            ...
            <Card className="mainCard">
              <Card.Body>
                ...
                <Row>
                  <Col>
                    <p>
                      <b>Goal:</b> To create a reliable, modern, and efficient
                      web application.
                    </p>
                    <p>
                    ...
                    <p>
                      <Asterisk />
                      Task/Issue management played a vital role in the project
                      as all the features are dependent on it.
                    </p>
                    <Row>
                      <Col sm={1}>
                        <a
                ...
                <Row>
                  <Col>
                    ...
                    <p>
                      ...
                      deployed in AWS Elastic beanstalk will communicate to
                      three containerized modules of the application deployed in
                      GCP Cloud Run.
                    </p>
                    <Row>
                      <Col sm={1}>
            ...
            <Card className="mainCard">
              <Card.Body>
                ...
                <Row>
                  <Col>
                    <p>
                      <b>Goal:</b> To work with exploring state space
                      algorithms.
                    </p>
                    <p>
